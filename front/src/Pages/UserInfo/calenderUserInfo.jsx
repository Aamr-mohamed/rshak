                ...
                <Form className="flex flex-col w-[100%]">
                  ...
                  <div className="flex flex-row gap-5 mb-3">
                    ...
                    >
                      ...
                      <option value="apple">1 مرات اسبوعياً</option>
                      <option value="apple">2 مرات اسبوعياً</option>
                      <option value="apple">3 مرات اسبوعياً</option>
                      <option value="apple">4 مرات اسبوعياً</option>
                      <option value="apple">5 مرات اسبوعياً</option>
                      <option value="apple">6 مرات اسبوعياً</option>
                      <option value="apple">7 مرات اسبوعياً</option>
                    </select>
