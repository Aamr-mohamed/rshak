...
const AttendanceCalendar = ({ userId }) => {
  ...
  const handleDayClick = async (date) => {
    ...
    try {
      ...
      await axios.patch(`${backendUrl}/user/update/attendance/${userId}`, [
        {
          date: splitDate,
          attendance: newAttendance === "attended",
        },
      ]);
    } catch (error) {
